...
const causes = ["mandate_expired", "card_expired", "otp_required", "bank_transient", "incorrect_upi_pin", "insufficient_funds"];
...
const causeDetails = {
  ...
  incorrect_upi_pin:   { error_code: "BAD_REQUEST_ERROR", error_source: "customer", error_reason_override: "incorrect_pin" },
...
function generateRecord(index) {
  ...
  return {
    ...
    error_reason: details.error_reason_override || cause,
