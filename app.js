...
var sampleExplanations = {
  ...
  incorrect_upi_pin: "The payment failed because the customer entered an incorrect UPI PIN. This is a one-time input error rather than a systemic issue, so prompting immediate re-entry gives a high chance of successful recovery.",
  insufficient_funds: "The payment failed because the customer's account did not have enough funds to cover the charge at that moment. Rather than an immediate retry, waiting 48-72 hours and timing the retry around typical income cycles gives a meaningfully higher chance of success.",
...
// Count failures by cause for the chart
var causeCounts = {};
failedPayments.forEach(function(payment) {
...
var labelMap = {
  ...
  incorrect_upi_pin: "Incorrect UPI PIN",
